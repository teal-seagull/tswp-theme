        ...
        <div id="container">
            <div id="content">
				...
				<?php if ( have_posts() ) : ?>
				                ...
				                <h1 class="page-title"><?php _e( 'Search Results for: ', 'tealseagull' ); ?><span><?php the_search_query(); ?></span></h1>
				...
				<?php else : ?>
				                ...
				                <div id="post-0" class="post no-results not-found">
				                    <h2 class="entry-title"><?php _e( 'Nothing Found', 'tealseagull' ) ?></h2>
				                    <div class="entry-content">
				                        <p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'tealseagull' ); ?></p>
				    <?php get_search_form(); ?>
				                    </div><!-- .entry-content -->
				                </div>
