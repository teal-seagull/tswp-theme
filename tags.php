<?php get_header(); ?>
        ...
        <div id="container">
            <div id="content">
				...
				<h1 class="page-title"><?php _e( 'Tag Archives:', 'tealseagull ) ?> <span><?php single_tag_title() ?></span></h1>
				...
				<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'tealseagull )  ); ?>
				                    ...
				                    <div class="entry-utility">
				                        ...
				                        <?php if ( $tag_ur_it = tag_ur_it(', ') ) : // Returns tags other than the one queried ?>
										                        <span class="tag-links"><?php printf( __( 'Also tagged %s', 'tealseagull ), $tag_ur_it ) ?></span>
										<?php endif; ?>
