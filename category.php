<?php get_header(); ?>
        ...
        <div id="container">
            <div id="content">
				...
				<h1 class="page-title"><?php _e( 'Category Archives:', 'tealseagull' ) ?> <span><?php single_cat_title() ?></span></span></h1>
				...
				<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'tealseagull' )  ); ?>
				                    ...
				                    <div class="entry-utility">
				                        <?php if ( $cats_meow = cats_meow(', ') ) : // Returns categories other than the one queried ?>
										                        <span class="cat-links"><?php printf( __( 'Also posted in %s', 'tealseagull' ), $cats_meow ) ?></span>
										                        <span class="meta-sep"> | </span>
										<?php endif ?>
				                        <span class="meta-sep"> | </span>
